 ...
 * Pro tier variant (identical to the Core variant) — no reviews SSR fetch
 * (lib/product-reviews is premium-only). Picked by scripts/export-tier.ts
 * in place of the default file when exporting Pro. Keep in sync with
 * page.core.tsx — export-tier.ts does exact-tier matching only, no
 * cross-tier fallback.
 */
