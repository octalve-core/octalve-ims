 ...
 * (Discovered this pass: unlike its 3 siblings — app/admin/invoices/[id],
 * app/admin/orders/[id], app/orders/[id] — this route never got a Core
 * variant in the Phase 9 Stripe-reconciliation fix.)
 */
