 ...
 *
 * Core variant: no Pay button (@/components/payments is Pro) and no Ship
 * button (@/components/shipping is Premium) — everything else identical.
 */

import React from "react";
import Link from "next/link";
import { ArrowLeft, Ban, Edit, FilePlus2, FileText, RefreshCw } from "lucide-react";
...
export function OrderDetailActionBar({
  ...
  mode: _mode,
  disableOrderActions,
  isSupplierRole: _isSupplierRole = false,
  allowPay: _allowPay = true,
  isCancelling,
  isRefunding = false,
  onBack,
  onUpdateOrder,
  ...
  void _isSupplierRole; // only gates the Pro/Premium Pay button
  void _allowPay; // only gates the Pro/Premium Pay button
