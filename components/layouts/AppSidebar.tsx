...
export default function AppSidebar({
  ...
  return (
    <>
      ...
      >
        <div className={cn("flex h-11 items-center gap-2 pb-5", collapsed ? "justify-center" : "px-1")}>
          <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-[10px] bg-[#0064E0] text-sm font-bold text-white">
            O
          </div>
          {!collapsed && <span className="text-[15px] font-semibold tracking-tight text-white">Octalve IMS</span>}
        </div>
        {body}
        {footer}
        {collapsed && (
