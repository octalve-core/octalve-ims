/**
 * Product row actions dropdown — Core tier variant (identical to Pro).
 ...
 * of the default file when exporting Core (see ProductActions.pro.tsx for
 * the identical Pro variant).
 */
