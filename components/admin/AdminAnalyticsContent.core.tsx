/**
 * Core tier variant — no AI demand forecasting section (lib/forecasting is
 * premium-only). Identical to AdminAnalyticsContent.pro.tsx — see its
 * header; export-tier.ts does exact-tier matching only, keep both in sync.
 */
"use client";
