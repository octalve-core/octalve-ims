/**
 * Product Detail Page — Pro tier variant (identical to the Core variant).
 ...
 * Keep in sync with ProductDetailPage.core.tsx — export-tier.ts does
 * exact-tier matching only, no cross-tier fallback.
 */
 ...
 * shape without importing premium code into a Pro-bucketed file. */
