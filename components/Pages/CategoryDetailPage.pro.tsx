/**
 * Category Detail Page — Pro tier variant (identical to the Core variant).
 * Same as CategoryDetailPage.tsx but without the Premium AI-forecast rollup
 ...
 * file when exporting Pro. Keep in sync with CategoryDetailPage.core.tsx —
    ...
    <PageWrapper>
      <PageContentWrapper>
        <div className={APP_SHELL_DETAIL_CLASS}>
          ...
          {/* REQ-0081/0084 — Category insights + charts (no AI forecast rollup in Core) */}
          {insights && (
            <CatalogInsightsSection
              insights={insights}
