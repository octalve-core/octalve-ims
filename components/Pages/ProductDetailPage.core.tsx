/**
 * Product Detail Page — Core tier variant.
 * Same as ProductDetailPage.tsx but without the Premium AI-forecast panel
 * (lib/forecasting/entity-forecast.ts) or the Premium reviews section
 * (components/product-reviews/ProductReviewsSection.tsx) — both
 * premium-bucketed, unavailable to Core and Pro alike. Picked by
 * scripts/export-tier.ts in place of the default file when exporting Core
 * (see ProductDetailPage.pro.tsx for the identical Pro variant). The
 * initialReviews/initialEligibility props stay in the signature (Phase 12:
 * the two product routes' own .core./.pro. variants now pass these as
 * undefined; ReviewEligibilityResult is redefined locally below instead of
 * imported from lib/product-reviews, so this file stays genuinely
 * tier-clean rather than reaching into premium for an unused type).
 */
    ...
    <PageWrapper>
      <PageContentWrapper>
        <div className={APP_SHELL_DETAIL_CLASS}>
          ...
          {/* No Premium reviews section in this tier */}
