/**
 * Invoice Detail Page — Core tier variant.
 * Same as InvoiceDetailPage.tsx but without the Stripe online-payment flow
 * (Core invoices are manual PDF only — lib/stripe/components/payments are
 * Pro+). Picked by scripts/export-tier.ts in place of the default file when
 * exporting Core.
