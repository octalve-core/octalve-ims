/**
 * Supplier Detail Page — Pro tier variant (identical to the Core variant).
 * Same as SupplierDetailPage.tsx but without the Premium AI-forecast rollup
 ...
 * file when exporting Pro. Keep in sync with SupplierDetailPage.core.tsx —
