 ...
 *
 * Core tier variant — no inline per-line-item reviews section
 * (components/product-reviews/ProductReviewsSection.tsx is premium-only).
 * Picked by scripts/export-tier.ts in place of the default file when
 * exporting Core (see .pro.tsx for the identical Pro variant). The
 * showReviews/initialReviewContext props stay in the signature (callers —
 * OrderItemsCard.tsx, InvoiceItemsCard.tsx — are untouched) but are unused
 * here.
 */
