...
export async function deleteAllDbData(
  ...
  const steps: DeleteStep[] = [
    ...
    { label: "Role", run: () => prisma.role.deleteMany({}) },
    { label: "Business", run: () => prisma.business.deleteMany({}) },
    { label: "ProductSupplier", run: () => prisma.productSupplier.deleteMany({}) },
    { label: "RefreshToken", run: () => prisma.refreshToken.deleteMany({}) },
    { label: "LoginAttempt", run: () => prisma.loginAttempt.deleteMany({}) },
