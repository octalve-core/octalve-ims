...
// Forecasting types (useForecastingSummary is already core-bucketed; the
// premium-exclusive rollup computation lives in lib/forecasting/, untouched)
export type {
  ProductSalesHistory,
